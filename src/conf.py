...
# -*- coding: utf-8 -*-
#
# ASP.NET MVC documentation build configuration file, created by
...
html_context = {
    'css_files': [
        ...
        'https://fonts.googleapis.com/css?family=Titillium+Web:300,300i,400,600,600i,700',  # overrides for wide tables in RTD theme
        ],
    'github_user' : 'ghk',
    'display_github' : True,
...
latex_documents = [
  (master_doc, 'kawaldesa.tex', 'Dokumentasi kawaldesa.org',
   'kawaldesa.org', 'manual'),
]
